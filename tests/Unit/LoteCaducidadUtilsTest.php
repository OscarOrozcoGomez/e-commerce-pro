...
final class LoteCaducidadUtilsTest extends TestCase
{
    ...
    private function seedProducto(int $id, string $nombre): void
    {
        $this->pdo->prepare("INSERT INTO productos (id_producto, nombre, sku, categoria, estado) VALUES (?, ?, ?, 'Salud', 'activo')")
            ->execute([$id, $nombre, 'SKU-' . $id]);
    }
