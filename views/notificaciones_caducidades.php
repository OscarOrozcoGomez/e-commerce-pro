...
requireAuth();
if (!hasPermission('configurar_notificaciones')) {
    header('Location: ' . BASE_URL . 'views/dashboard.php');
    exit;
}

$pageTitle = 'Notificaciones de Caducidades';
$pdo = getPDO();
$error = '';
$success = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['accion'])) {
    if (!validateCsrfToken($_POST['csrf_token'] ?? '')) {
        ...
        if ($accion === 'agregar') {
            ...
            $resultado = dbAddCaducidadNotificationEmail($pdo, $correo);
            ...
            if (dbSetCaducidadNotificationEmailActive($pdo, $idCorreo, $nuevoActivo)) {
            ...
            $idCorreo = (int) ($_POST['id_correo'] ?? 0);
            if (dbDeleteCaducidadNotificationEmail($pdo, $idCorreo)) {
...
$correos = dbGetCaducidadNotificationEmails($pdo);
    ...
    <div class="row">
        <div class="col s12">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 20px; flex-wrap: wrap; gap: 10px;">
                <h4 style="margin: 0;"><i class="material-icons left">mark_email_unread</i> Notificaciones de Caducidades</h4>
            ...
            <p class="grey-text" style="margin-top: 4px;">
                Cuando un lote cambia de severidad (por ejemplo pasa de "Planificar" a "Urgente", o entra en "No vendible"), se envía un correo con el detalle a todos los correos activos de esta lista. Se revisa una vez al día.
            </p>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn orange darken-3 w-100">Agregar a la Lista</button>
                    </form>
