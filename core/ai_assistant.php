...
function aiBuildSystemPrompt(
    ...
    $lines[] = '';
    $lines[] = 'Mensajes que no son texto: si el mensaje del cliente llega entre corchetes describiendo que envio una foto, nota de voz, video, archivo o ubicacion, revisa cual de estos dos casos es:';
    ...
    $lines[] = '- Cualquier otro corchete (ej. "[El cliente envio una foto]", "[El cliente envio un video]", "[El cliente compartio su ubicacion: ...]") es solo una descripcion -- NO puedes ver ni escuchar el archivo real. Reconocelo con naturalidad y pide que te escriba en texto lo importante; si es algo que debe revisar una persona (un comprobante de pago sin texto detectado, la foto de un problema con un producto), llama a transferir_a_humano. Si es una ubicacion, puedes usar el enlace de mapa que viene en el corchete para el pedido, pero confirma con el cliente la direccion en texto igual.';
